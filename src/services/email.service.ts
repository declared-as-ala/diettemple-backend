      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#fff;border-radius:12px;overflow:hidden;">
        ...
        <div style="padding:28px 32px;space-y:16px;">
          <table style="width:100%;border-collapse:collapse;">
            ...
            ${lead.goal ? `<tr style="border-top:1px solid #1f1f1f;"><td style="padding:10px 0;color:rgba(255,255,255,0.5);font-size:12px;text-transform:uppercase;letter-spacing:0.5px;">Objectif</td><td style="padding:10px 0;color:#fff;font-size:14px;">${goalLabel}</td></tr>` : ''}
